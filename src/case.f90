...
!!! DESCRIPTION: This file interfaces the case specific code.
!!               The case specific code is located in case/ and consists of a series of
!!               include files which this file provides wrappers around.
!!!  COMMENTARY: This file is based on the original "BC-TGV.f90"
!!!   CHANGELOG: - [2018-11-06] Added the fluid_userinit subroutine.
!!                 This subroutine is called by the init subroutine and initialises the
!!                 velocity field.
!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
SUBROUTINE init_velocity_user(ux1, uy1, uz1)
  !!=======================================================================
  !!
  !!  SUBROUTINE: init_velocity_user
  !! DESCRIPTION: Stub subroutine, body is contained in the user generated
  !!              per case include file case/
  !!              The purpose of this subroutine is to set the initial
  !!              velocity field.
  !!
  !!=======================================================================
#include "fluid_userinit.inc"
ENDSUBROUTINE init_velocity_user
...
subroutine init (ux1,uy1,uz1,ep1,phi1,gx1,gy1,gz1,phis1,hx1,hy1,hz1,phiss1)
  ...
  else if (iin.eq.1) then
     if (nrank==0) write(*,*) "Filled initial domain!"

     CALL init_velocity_user(ux1, uy1, uz1)
  endif
